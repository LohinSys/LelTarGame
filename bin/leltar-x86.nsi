...
VIAddVersionKey /LANG=${LANG_ENGLISH} "ProductName" "Lel.tar Setup (x86)"
VIAddVersionKey /LANG=${LANG_ENGLISH} "Comments" "x86/IA-32 Installer for Lel.tar"
...
VIAddVersionKey /LANG=${LANG_ENGLISH} "FileDescription" "x86/IA-32 Installer for Lel.tar"
...
Section "un.Lel.tar"
	...
	; Files go here...
	Delete "$INSTDIR\LelTarGame-x86.exe"
	Delete "$INSTDIR\LelTarGame-x86.pck"
